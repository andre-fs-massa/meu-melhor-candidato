...
Página local: abrir `prototipo/index.html` no navegador (funciona por duplo clique, sem servidor). Os dados vêm de
`prototipo/dados.js`, gerado por `python -m pipeline.exportar_prototipo` a partir do próprio funil (corte 6,0; só recomenda
