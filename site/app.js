(function () {
  ...
  function renderMetodologia() {
    ...
    [`Cobertura desigual: Presidente, Governador e Senador têm pesquisa individual na internet em todos os estados. Deputados federal, estadual e distrital têm só verificação estrutural: círculo político (presidente do partido), cargos eletivos de 2014 a 2024 e conferência em bases oficiais; ali, nota 10 quer dizer apenas que nada consta nessas bases, sem incluir processos judiciais, inquéritos nem notícias. Nos estados já concluídos (SP, MG, RJ, BA, PR, RS, PE, CE, PA, SC, GO, MA, AM, ES, PB, MT, RN, PI, AL, DF, MS, SE, RO, TO, AC e AP), os finalistas de deputado e quem empata com eles também tiveram uma busca rápida na internet (1 busca por candidato); os demais estados seguem só com a verificação estrutural. A pesquisa de Senador foi feita com busca mais rápida (1 a 2 buscas por candidato), então nota 10 vale como "nada encontrado", não como atestado.`,
